namespace Envelopes.TextMessages
{
    public static class UIMessages
    {
        ...
        public const string INPUT_FIRST_ENVELOPE = "Input first envelope 'width height' :";
        public const string INPUT_SECOND_ENVELOPE = "Input second envelope 'width height' :";
        ...
        public const string FORMAT_EXEPTION = "Invalid format of arguments, correct format is 'width height' ";
